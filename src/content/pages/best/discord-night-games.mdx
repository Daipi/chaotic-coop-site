...
metaDescription: "A prototype list for friend-first games that are easy to recommend when a group is deciding what to play."
type: "best"
...
summary: "A broader list that helps support chaos-focused pages with a more human query."
quickPickGames:
  - "content-warning"
  - "peak"
  - "repo"
...
gamesMentioned:
  ...
  - "phasmophobia"
keyTakeaways:
  - "This page is a human-language bridge between game-night intent and specific subgenres."
