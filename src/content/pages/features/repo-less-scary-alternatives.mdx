...
metaDescription: "A prototype intent-split page for readers who want chaotic co-op energy without the heaviest horror."
type: "feature"
...
intro: "This page serves the softer intent hidden inside the main R.E.P.O.-like query cluster."
summary: "An intent-split feature page for lower-horror recommendations."
comparedGames:
  - "content-warning"
  - "peak"
comparisonFields:
...
gamesMentioned:
  ...
  - "lethal-company"
keyTakeaways:
  - "This page should split the intent by fear tolerance, not just list random co-op games."
